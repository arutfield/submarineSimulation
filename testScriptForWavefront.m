...
% script for testing wavefront
% creates sample map and adds start/finish test points. Then generates a path
% using wavefront and shows it moving

% setup map and test points for map-coordinate conversion
pkg load geometry;
clear; close all;
resolution = 2;
...
% pt conversion test (may fail if resolution > 1)
...
% add start/finish points and generate wavefront paths
startPoint1=[-2 2 0]';
finishPoint1=[2 2.5 0]';
wavePath1 = generateWavefrontPath(startPoint1, finishPoint1, map, resolution);

startPoint2=[-2 2.5 0]';
finishPoint2=[2 -2.5 0]'
wavePath2 = generateWavefrontPath(startPoint2, finishPoint2, map, resolution);
 
startPoint1_3d = [-1.5 1 -0.5]';
finishPoint1_3d = [1.5 2 -3.5]';
wavePath1_3d = generateWavefrontPath(startPoint1_3d, finishPoint1_3d, map3D, resolution);

startPoint2_3d = [-1 -2 -3.5]';
finishPoint2_3d = [-1.5 2 -0.5]';
wavePath2_3d = generateWavefrontPath(startPoint2_3d, finishPoint2_3d, map3D, resolution);

% get wave paths into coordiantes
