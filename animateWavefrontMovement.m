% animateWavefrontMovement - perform submarine movements through wavefront path
%  inputs:
%   knownMap - map with known areas indicated (0 unknown, 1 open, 2 obstacle,
%              3 submarine
%   fullMap - full map of region with no unknowns
%   expandedObstaclesMap - known map with sub as one space and obstacles
%                          expanded
%   wavefrontPathMap - path of submarine to take in map domain
%   submarineDimensions - dimensions of submarine
%   flashlightRange - range of submarine lights
%   resolution - resolution of map
%   maxSpeed - maximum allowed speed of submarine
%   acceleration - sub acceleration rate
%   deceleration - sub deceleration rate
%   figureHandle - visual figure handle
%   oldSubHandles - figure handles of submarine on visual
%   maximumDepth - maximum allowed depth of submarine
%  outputs:
%   knownMap - known version of map after movement
%   expandedObstaclesMap - expanded obstacle version of knownMap
%   figureHandle - figure handle of visual
%   totalTime - total time for movements to be completed
%   finalSubPosition - last known sub position when movement is completed
%   oldSubHandles - updated sub handles
%   success - true if movement was successful
function [knownMap, expandedObstaclesMap, figureHandle, totalTime,...
  finalSubPosition, oldSubHandles, success] =...
  animateWavefrontMovement(knownMap, fullMap, expandedObstaclesMap,...
  wavefrontPathMap, submarineDimensions, flashlightRange,...
  resolution, maxSpeed, acceleration, deceleration, figureHandle,...
  oldSubHandles, maximumDepth=Inf);
  success=true;
  twoDimensions=true;
